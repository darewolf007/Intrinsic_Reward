...
class PickCubeEnv(BaseEnv):
    ...
    **Success Conditions:**
    ...
    def _default_sensor_configs(self):
        ...
        left_base_pose = sapien_utils.look_at(eye=[-0.38155, 1.2102138255883726, 0.4851141636379064], target=[-0.35978, 0.13906, 0.30676])
        if self.random_cfg["camera_random"]:
            ...
            return [CameraConfig("left_camera", left_base_pose, width=128, height=128, intrinsic=intrinsic_128, near=0.01, far=100),
            CameraConfig("base_camera", pose=pose, width=128, height=128, intrinsic=intrinsic_128, near=0.01, far=100)]
            ...
            for render_body_component in render_body_component_list:
                for render_shape in render_body_component.render_shapes:
                    for part in render_shape.parts:
                        part.material.set_base_color(self._batched_episode_rng[0].uniform(low=0., high=1., size=(3, )).tolist() + [1])
